...
// deletePokemon(); We can comment these out since this is only for personal checking.

// console.log("Registered Pokemon:");
...
function registerTrainer(name, level, pkmnArray){
    let trainer = {
        trainerName: name,
        trainerLevel: level,
        pokemons: pkmnArray
