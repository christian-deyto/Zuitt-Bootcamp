console.log("Hello Friday the 13th")
...
/*
   ...
   1. Create a function called displayValues() which is able to receive an array of numbers and display cubed values in the console.
        - Use the forEach() method to print the cube of each number on a new line.
*/
...
*/
    function celsiusToFahrenheit(tempsArray){
        let convertedArray = tempsArray.map(function(temp){
            return ((temp * 9 / 5) + 32)
        });
