...
*/
    ...
    let monthsYear = 12;
    let daysYear = 365;
    let resultMinutes = minutesHour * hoursDay * daysYear; // Calculate total minutes in a year
    console.log("There are " + resultMinutes + " in a year.");
...
*/
    let tempCelsius = 132;
    let resultFahrenheit = (tempCelsius * 9/5) + 32; // Convert Celsius to Fahrenheit
